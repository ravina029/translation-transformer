...
MHA_TEST_DATA = [
    ...
    (
        ...
        torch.tensor([
            ...
            [[-0.2657615542411804, -1.1095069646835327, 1.575529932975769, -2.953308582305908],

             [-0.31810081005096436, -1.3583225011825562, 1.0969884395599365, -3.5557737350463867],

             [-1.0363497734069824, 0.1544792652130127, 0.8307660818099976, -0.6420033574104309]],

            [[3.41835618019104, -3.4588632583618164, 2.471224546432495, -2.2303943634033203],

             [-0.835513710975647, 0.5645291805267334, -2.178706645965576, -0.2814210057258606],

             [1.3362171649932861, -1.6601970195770264, 0.15386708080768585, -1.618969202041626]]
    ...
    (
        ...
        torch.tensor([
            ...
            [[-1.8750097751617432, 3.4548227787017822, 2.242863178253174, 6.896119117736816],

             [-1.439692735671997, 1.0199611186981201, 0.8919554948806763, 0.4862484931945801],

             [-1.0363497734069824, 0.1544792652130127, 0.8307660818099976, -0.6420033574104309]],

            [[3.5263192653656006, -6.098883628845215, 1.9741934537887573, -7.373747825622559],
    ...
    (
        ...
        torch.tensor([
            ...
            [[-1.5669221878051758, 5.281073570251465, -1.7499525547027588, 8.89909839630127],

             [-1.5669221878051758, 5.281073570251465, -1.7499525547027588, 8.89909839630127],

             [-1.5669221878051758, 5.281073570251465, -1.7499525547027588, 8.89909839630127]],

            [[0.13075685501098633, -4.142998218536377, 2.939213275909424, -7.535215854644775],

             [-0.38490769267082214, 0.6016770601272583, -1.6096503734588623, 0.05100858211517334],

             [0.9850694537162781, -2.1259379386901855, 0.8979899883270264, -2.8792083263397217]]
...
STATE_DICT = {
    ...
    "key_transform.weight": torch.tensor([[-0.3609, -0.0606,  0.0733,  0.8187],
    ...
    "value_transform.weight": torch.tensor([[1.0414, -0.3997, -2.2933,  0.4976],
    ...
    "output_transform.weight": torch.tensor([[0.9633, -0.3095,  0.5712,  1.1179],
